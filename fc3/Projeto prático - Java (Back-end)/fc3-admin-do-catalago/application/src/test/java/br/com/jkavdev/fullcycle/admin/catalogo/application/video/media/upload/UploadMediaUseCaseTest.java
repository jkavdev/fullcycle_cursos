...
public class UploadMediaUseCaseTest extends UseCaseTest {
    ...
    @Test
    public void givenCmdToUpload_whenIsValid_shouldUploadVideoMediaAndPersistIt() {
        // given
    ...
    @Test
    public void givenCmdToUpload_whenIsValid_shouldUploadTrailerMediaAndPersistIt() {
        // given
        final var aVideo = Fixture.Videos.systemDesign();
        final var expectedId = aVideo.getId();
    ...
    @Test
    public void givenCmdToUpload_whenIsValid_shouldUploadBannerMediaAndPersistIt() {
        // given
        final var aVideo = Fixture.Videos.systemDesign();
        final var expectedId = aVideo.getId();
    ...
    @Test
    public void givenCmdToUpload_whenIsValid_shouldUploadThumbnailMediaAndPersistIt() {
        // given
        final var aVideo = Fixture.Videos.systemDesign();
        final var expectedId = aVideo.getId();
    ...
    @Test
    public void givenCmdToUpload_whenIsValid_shouldUploadThumbnailHalfMediaAndPersistIt() {
        // given
        final var aVideo = Fixture.Videos.systemDesign();
        final var expectedId = aVideo.getId();
    ...
    @Test
    public void givenCmdToUpload_whenIsInvalid_shouldReturnNotFound() {
        // given
        final var aVideo = Fixture.Videos.systemDesign();
        final var expectedId = aVideo.getId();
        final var expectedType = VideoMediaType.THUMBNAIL_HALF;
        ...
        final var actualException =
                Assertions.assertThrows(NotFoundException.class, () -> useCase.execute(aCmd));
