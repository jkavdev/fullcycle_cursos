...
import br.com.jkavdev.fullcycle.admin.catalogo.application.genre.retrieve.list.GenreListOutput;
...
import static br.com.jkavdev.fullcycle.admin.catalogo.ApiTest.GENRES_JWT;
...
public class GenreAPITest {
    ...
    public void givenValidParams_whenCallsListGenres_shouldReturnGenres() throws Exception {
        ...
        verify(listGenresUseCase).execute(argThat(query ->
